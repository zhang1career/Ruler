...
import lab.zhang.ruler.pojo.executors.iterating_executors.ParallelIteratingAnalyzer;
...
public class ParallelIteratingAnalyzerTest {
    ...
    public void test_getValue() {
        ...
        ParallelIteratingAnalyzer<Integer> exe1 = new ParallelIteratingAnalyzer<>(tion5);
        ...
        ParallelIteratingAnalyzer<Integer> exe11 = new ParallelIteratingAnalyzer<>(tion11);
        ParallelIteratingAnalyzer<Integer> exe12 = new ParallelIteratingAnalyzer<>(tion12);
    ...
    public void test_getValue_perf() {
        ...
        ParallelIteratingAnalyzer<Integer> exe1 = new ParallelIteratingAnalyzer<>(tion250);
